...
# CPU Load
S1_1 = sf.FuzzySet(points=[[0, 1.], [0.45, 0.1], [0.50, 0]], term="low_load")
S1_2 = sf.FuzzySet(points=[[0.4, 0], [0.45, 0.1], [0.60, 1.],[0.7, 0.25], [0.75, 0]], term="medium_load")
S1_3 = sf.FuzzySet(points=[[0.6, 0], [0.7, 0.25], [1, 1.]], term="high_load")
FS1.add_linguistic_variable("CPU_LOAD", sf.LinguisticVariable([S1_1, S1_2, S1_3]))

# MEM USE
S2_1 = sf.FuzzySet(points=[[0, 1.], [0.45, 0.1], [0.50, 0]], term="low_use")
S2_2 = sf.FuzzySet(points=[[0.4, 0], [0.45, 0.1], [0.60, 1.],[0.7, 0.25], [0.75, 0]], term="medium_use")
S2_3 = sf.FuzzySet(points=[[0.6, 0], [0.7, 0.25], [1, 1.]], term="high_use")
FS1.add_linguistic_variable("MEM_USE", sf.LinguisticVariable([S2_1, S2_2, S2_3]))

# INPUT NET
S3_1 = sf.FuzzySet(points=[[0, 1.], [0.45, 0.1], [0.50, 0]], term="low_input")
S3_2 = sf.FuzzySet(points=[[0.4, 0], [0.45, 0.1], [0.60, 1.],[0.7, 0.25], [0.75, 0]], term="medium_input")
S3_3 = sf.FuzzySet(points=[[0.6, 0], [0.7, 0.25], [1, 1.]], term="high_input")
FS1.add_linguistic_variable("NET_INPUT", sf.LinguisticVariable([S3_1, S3_2, S3_3]))

#FS1.set_crisp_output_value("LOWER_CLP", -1)
#FS1.set_crisp_output_value("MAINTAIN_CLP", 0)
#FS1.set_crisp_output_value("INCREASE_CLP", 1)

FS1.set_output_function("LOWER_CLP", "-1*(0.7*MEM_USE*NET_INPUT+0.3*CPU_LOAD)")
...
FS1.set_variable("CPU_LOAD", .8)
FS1.set_variable("MEM_USE",.3)
FS1.set_variable("NET_INPUT", .0)
print(FS1.Sugeno_inference(['CLP']))